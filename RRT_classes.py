...
class RRTMap:
    def __init__(self, start, goal, MapDimensions, obsdim, obsnum):
        ...
        self.Maphight, self.Mapwidth = self.MapDimensions

        #Window settins:

        self.MapWindowName = "RTT planning simulation"
        pygame.display.set_caption(self.MapWindowName)
        self.map = pygame.display.set_mode((self.Mapwidth, self.Maphight))
...
class RRTGraph:
    ...
    #Method to creat upper left corner
    def makeRandomRect(self):
        uppercornerx = int(random.uniform(0, self.Mapwidth - self.obsDim))
        uppercornery = int(random.uniform(0, self.Maphight - self.obsDim))
    ...
    def makeobs(self):
        ...
        for i in range(0, self.obdsNum):
            rectangle = None
            startgoalcol = True #create rectangle that don't collide with start and goal point
        ...
        self.obstacles = obs.copy() #list copied to class variable
        return obs
    ...
    def distance(self, n1, n2): #euclidian dist sqrt(px + py), px = (x1 - x2)^2
    ...
    def sample_envir(self):
        ...
        y = int(random.uniform(0, self.Maphight))
        return x, y
